...
DATA_URL = (
    "/home/blaq/Downloads/streamkit-master/data/Motor_Vehicle_Collisions_-_Crashes.csv" )
	#Change PATH

st.title("Motor Vehicle Collisions in New York City")
st.subheader("A simple application to analyze motor vehicle collisions in New York City")
